...
void kernel15(dtype_t dtype){
  ...
  kernel_manager_t km;
  auto const& [is_built,wsz] = km.build(reduction);
...
void kernel2(dtype_t dtype){
  ...
  kernel_manager_t km;
  auto const& [is_built,wsz] = km.build(power_2);
...
void kernel1(dtype_t src, dtype_t dst){
  ...
  kernel_manager_t km;
  auto const& [is_built,wsz] = km.build(convert);
...
void kernel13(dtype_t dtype){
  ...
  kernel_manager_t km;
  auto const& [is_built,wsz] = km.build(elementwise);
...
void kernel4(dtype_t dtype){
  ...
  kernel_manager_t km;
  auto const& [is_built,wsz] = km.build(increment);
