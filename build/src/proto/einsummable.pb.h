...
extern LowertriDefaultTypeInternal _Lowertri_default_instance_;
class MGAlloc;
...
namespace google {
namespace protobuf {
template<> ::es_proto::Constant* Arena::CreateMaybeMessage<::es_proto::Constant>(Arena*);
...
template<> ::es_proto::Lowertri* Arena::CreateMaybeMessage<::es_proto::Lowertri>(Arena*);
...
class Constant : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:es_proto.Constant) */ {
 public:
  Constant();
  virtual ~Constant();
  ...
  inline Constant* New() const final {
    return CreateMaybeMessage<Constant>(NULL);
  }

  Constant* New(::google::protobuf::Arena* arena) const final {
  ...
  // @@protoc_insertion_point(class_scope:es_proto.Constant)
 private:
  void set_has_value();
...
class Lowertri : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:es_proto.Lowertri) */ {
 public:
  Lowertri();
  virtual ~Lowertri();

  Lowertri(const Lowertri& from);

  inline Lowertri& operator=(const Lowertri& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  Lowertri(Lowertri&& from) noexcept
    : Lowertri() {
    *this = ::std::move(from);
  }

  inline Lowertri& operator=(Lowertri&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const Lowertri& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Lowertri* internal_default_instance() {
    return reinterpret_cast<const Lowertri*>(
               &_Lowertri_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  void Swap(Lowertri* other);
  friend void swap(Lowertri& a, Lowertri& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline Lowertri* New() const final {
    return CreateMaybeMessage<Lowertri>(NULL);
  }

  Lowertri* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<Lowertri>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const Lowertri& from);
  void MergeFrom(const Lowertri& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Lowertri* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  ::google::protobuf::uint64 ncol() const;
  void set_ncol(::google::protobuf::uint64 value);

  // required uint64 nrow = 4;
  bool has_nrow() const;
  void clear_nrow();
  static const int kNrowFieldNumber = 4;
  ::google::protobuf::uint64 nrow() const;
  void set_nrow(::google::protobuf::uint64 value);
  ...
  // @@protoc_insertion_point(class_scope:es_proto.Lowertri)
 private:
  void set_has_lower();
  ...
  ::google::protobuf::uint64 ncol_;
  ::google::protobuf::uint64 nrow_;
...
class Fill : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:es_proto.Fill) */ {
 public:
  ...
  private:
  const ::es_proto::Constant& _internal_constant() const;
  public:
  const ::es_proto::Constant& constant() const;
  ::es_proto::Constant* release_constant();
  ::es_proto::Constant* mutable_constant();
  void set_allocated_constant(::es_proto::Constant* constant);

  // optional .es_proto.Lowertri lowertri = 2;
  bool has_lowertri() const;
  void clear_lowertri();
  static const int kLowertriFieldNumber = 2;
  private:
  const ::es_proto::Lowertri& _internal_lowertri() const;
  public:
  const ::es_proto::Lowertri& lowertri() const;
  ::es_proto::Lowertri* release_lowertri();
  ::es_proto::Lowertri* mutable_lowertri();
  void set_allocated_lowertri(::es_proto::Lowertri* lowertri);
 ...
 private:
  ...
  union OpUnion {
    OpUnion() {}
    ::es_proto::Constant* constant_;
    ::es_proto::Lowertri* lowertri_;
  } op_;
...
inline const ::std::string& Constant::value() const {
  // @@protoc_insertion_point(field_get:es_proto.Constant.value)
  return value_.GetNoArena();
}
inline void Constant::set_value(const ::std::string& value) {
  set_has_value();
  value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:es_proto.Constant.value)
}
#if LANG_CXX11
inline void Constant::set_value(::std::string&& value) {
  set_has_value();
  value_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:es_proto.Constant.value)
}
#endif
inline void Constant::set_value(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_value();
  value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:es_proto.Constant.value)
}
inline void Constant::set_value(const char* value, size_t size) {
  set_has_value();
  value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:es_proto.Constant.value)
}
inline ::std::string* Constant::mutable_value() {
  set_has_value();
  // @@protoc_insertion_point(field_mutable:es_proto.Constant.value)
  return value_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Constant::release_value() {
  // @@protoc_insertion_point(field_release:es_proto.Constant.value)
  if (!has_value()) {
    return NULL;
  }
  clear_has_value();
...
inline void Constant::set_allocated_value(::std::string* value) {
  if (value != NULL) {
    set_has_value();
  } else {
    clear_has_value();
  ...
  // @@protoc_insertion_point(field_set_allocated:es_proto.Constant.value)
}

// repeated uint64 shape = 2;
inline int Constant::shape_size() const {
  return shape_.size();
}
inline void Constant::clear_shape() {
  shape_.Clear();
}
inline ::google::protobuf::uint64 Constant::shape(int index) const {
  // @@protoc_insertion_point(field_get:es_proto.Constant.shape)
  return shape_.Get(index);
}
inline void Constant::set_shape(int index, ::google::protobuf::uint64 value) {
  shape_.Set(index, value);
  // @@protoc_insertion_point(field_set:es_proto.Constant.shape)
}
inline void Constant::add_shape(::google::protobuf::uint64 value) {
  shape_.Add(value);
  // @@protoc_insertion_point(field_add:es_proto.Constant.shape)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >&
Constant::shape() const {
  // @@protoc_insertion_point(field_list:es_proto.Constant.shape)
  return shape_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint64 >*
Constant::mutable_shape() {
  // @@protoc_insertion_point(field_mutable_list:es_proto.Constant.shape)
  return &shape_;
}
...
// required string lower = 1;
inline bool Lowertri::has_lower() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Lowertri::set_has_lower() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Lowertri::clear_has_lower() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Lowertri::clear_lower() {
  lower_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_lower();
}
inline const ::std::string& Lowertri::lower() const {
  // @@protoc_insertion_point(field_get:es_proto.Lowertri.lower)
  return lower_.GetNoArena();
}
inline void Lowertri::set_lower(const ::std::string& value) {
  set_has_lower();
  lower_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:es_proto.Lowertri.lower)
}
#if LANG_CXX11
inline void Lowertri::set_lower(::std::string&& value) {
  set_has_lower();
  lower_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:es_proto.Lowertri.lower)
}
#endif
inline void Lowertri::set_lower(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_lower();
  lower_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:es_proto.Lowertri.lower)
}
inline void Lowertri::set_lower(const char* value, size_t size) {
  set_has_lower();
  lower_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:es_proto.Lowertri.lower)
}
inline ::std::string* Lowertri::mutable_lower() {
  set_has_lower();
  // @@protoc_insertion_point(field_mutable:es_proto.Lowertri.lower)
  return lower_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Lowertri::release_lower() {
  // @@protoc_insertion_point(field_release:es_proto.Lowertri.lower)
  if (!has_lower()) {
    return NULL;
  }
  clear_has_lower();
  return lower_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void Lowertri::set_allocated_lower(::std::string* lower) {
  if (lower != NULL) {
    set_has_lower();
  } else {
    clear_has_lower();
  ...
  // @@protoc_insertion_point(field_set_allocated:es_proto.Lowertri.lower)
}

// required string upper = 2;
inline bool Lowertri::has_upper() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Lowertri::set_has_upper() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Lowertri::clear_has_upper() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void Lowertri::clear_upper() {
  upper_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_upper();
}
inline const ::std::string& Lowertri::upper() const {
  // @@protoc_insertion_point(field_get:es_proto.Lowertri.upper)
  return upper_.GetNoArena();
}
inline void Lowertri::set_upper(const ::std::string& value) {
  set_has_upper();
  upper_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:es_proto.Lowertri.upper)
}
#if LANG_CXX11
inline void Lowertri::set_upper(::std::string&& value) {
  set_has_upper();
  upper_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:es_proto.Lowertri.upper)
}
#endif
inline void Lowertri::set_upper(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_upper();
  upper_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:es_proto.Lowertri.upper)
}
inline void Lowertri::set_upper(const char* value, size_t size) {
  set_has_upper();
  upper_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:es_proto.Lowertri.upper)
}
inline ::std::string* Lowertri::mutable_upper() {
  set_has_upper();
  // @@protoc_insertion_point(field_mutable:es_proto.Lowertri.upper)
  return upper_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Lowertri::release_upper() {
  // @@protoc_insertion_point(field_release:es_proto.Lowertri.upper)
  if (!has_upper()) {
    return NULL;
  }
  clear_has_upper();
  return upper_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void Lowertri::set_allocated_upper(::std::string* upper) {
  if (upper != NULL) {
    set_has_upper();
  } else {
    clear_has_upper();
  ...
  // @@protoc_insertion_point(field_set_allocated:es_proto.Lowertri.upper)
}

// required uint64 ncol = 3;
inline bool Lowertri::has_ncol() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Lowertri::set_has_ncol() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Lowertri::clear_has_ncol() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Lowertri::clear_ncol() {
  ncol_ = GOOGLE_ULONGLONG(0);
  clear_has_ncol();
}
inline ::google::protobuf::uint64 Lowertri::ncol() const {
  // @@protoc_insertion_point(field_get:es_proto.Lowertri.ncol)
  return ncol_;
}
inline void Lowertri::set_ncol(::google::protobuf::uint64 value) {
  set_has_ncol();
  ncol_ = value;
  // @@protoc_insertion_point(field_set:es_proto.Lowertri.ncol)
}

// required uint64 nrow = 4;
inline bool Lowertri::has_nrow() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void Lowertri::set_has_nrow() {
  _has_bits_[0] |= 0x00000008u;
}
inline void Lowertri::clear_has_nrow() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void Lowertri::clear_nrow() {
  nrow_ = GOOGLE_ULONGLONG(0);
  clear_has_nrow();
}
inline ::google::protobuf::uint64 Lowertri::nrow() const {
  // @@protoc_insertion_point(field_get:es_proto.Lowertri.nrow)
  return nrow_;
}
inline void Lowertri::set_nrow(::google::protobuf::uint64 value) {
  set_has_nrow();
  nrow_ = value;
  // @@protoc_insertion_point(field_set:es_proto.Lowertri.nrow)
}

// required int64 start = 5;
inline bool Lowertri::has_start() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void Lowertri::set_has_start() {
  _has_bits_[0] |= 0x00000010u;
}
inline void Lowertri::clear_has_start() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void Lowertri::clear_start() {
  start_ = GOOGLE_LONGLONG(0);
  clear_has_start();
}
inline ::google::protobuf::int64 Lowertri::start() const {
  // @@protoc_insertion_point(field_get:es_proto.Lowertri.start)
  return start_;
}
inline void Lowertri::set_start(::google::protobuf::int64 value) {
  set_has_start();
  start_ = value;
  // @@protoc_insertion_point(field_set:es_proto.Lowertri.start)
}
...
// optional .es_proto.Constant constant = 1;
inline bool Fill::has_constant() const {
  return op_case() == kConstant;
}
inline void Fill::set_has_constant() {
  _oneof_case_[0] = kConstant;
}
inline void Fill::clear_constant() {
  if (has_constant()) {
    delete op_.constant_;
    clear_has_op();
  }
}
inline const ::es_proto::Constant& Fill::_internal_constant() const {
  return *op_.constant_;
}
inline ::es_proto::Constant* Fill::release_constant() {
  // @@protoc_insertion_point(field_release:es_proto.Fill.constant)
  if (has_constant()) {
    clear_has_op();
      ::es_proto::Constant* temp = op_.constant_;
    op_.constant_ = NULL;
    return temp;
  } else {
    return NULL;
...
inline const ::es_proto::Constant& Fill::constant() const {
  // @@protoc_insertion_point(field_get:es_proto.Fill.constant)
  return has_constant()
      ? *op_.constant_
      : *reinterpret_cast< ::es_proto::Constant*>(&::es_proto::_Constant_default_instance_);
}
inline ::es_proto::Constant* Fill::mutable_constant() {
  if (!has_constant()) {
    clear_op();
    set_has_constant();
    op_.constant_ = CreateMaybeMessage< ::es_proto::Constant >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:es_proto.Fill.constant)
  return op_.constant_;
}

// optional .es_proto.Lowertri lowertri = 2;
inline bool Fill::has_lowertri() const {
  return op_case() == kLowertri;
}
inline void Fill::set_has_lowertri() {
  _oneof_case_[0] = kLowertri;
}
inline void Fill::clear_lowertri() {
  if (has_lowertri()) {
    delete op_.lowertri_;
    clear_has_op();
  }
}
inline const ::es_proto::Lowertri& Fill::_internal_lowertri() const {
  return *op_.lowertri_;
}
inline ::es_proto::Lowertri* Fill::release_lowertri() {
  // @@protoc_insertion_point(field_release:es_proto.Fill.lowertri)
  if (has_lowertri()) {
    clear_has_op();
      ::es_proto::Lowertri* temp = op_.lowertri_;
    op_.lowertri_ = NULL;
    return temp;
  } else {
    return NULL;
...
inline const ::es_proto::Lowertri& Fill::lowertri() const {
  // @@protoc_insertion_point(field_get:es_proto.Fill.lowertri)
  return has_lowertri()
      ? *op_.lowertri_
      : *reinterpret_cast< ::es_proto::Lowertri*>(&::es_proto::_Lowertri_default_instance_);
}
inline ::es_proto::Lowertri* Fill::mutable_lowertri() {
  if (!has_lowertri()) {
    clear_op();
    set_has_lowertri();
    op_.lowertri_ = CreateMaybeMessage< ::es_proto::Lowertri >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:es_proto.Fill.lowertri)
  return op_.lowertri_;
}

inline bool Fill::has_op() const {
  return op_case() != OP_NOT_SET;
}
inline void Fill::clear_has_op() {
  _oneof_case_[0] = OP_NOT_SET;
}
inline Fill::OpCase Fill::op_case() const {
  return Fill::OpCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
