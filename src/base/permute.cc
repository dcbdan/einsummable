...
permute_t::permute_t(uint64_t min_block_size) : min_block_size(min_block_size) {}

tuple<vector<uint64_t>, vector<uint64_t>> permute_t::build_strides(vector<uint64_t> const& dims,
