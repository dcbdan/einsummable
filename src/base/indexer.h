...
struct indexer_utils {
    ...
    static bool increment_idxs_region(vector<tuple<I, I>> const& region, vector<I>& idxs)
    {
        bool could_increment = false;
...
bool        increment_idxs_region(vector<tuple<int, int>> const& region, vector<int>& idxs);
