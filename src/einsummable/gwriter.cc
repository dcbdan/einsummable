...
//   A B C D E -> A D C B E
template <typename T>
void rotate_sections(vector<T>& items, tuple<int, int> lhs, tuple<int, int> rhs)
{
    {
    ...
    std::rotate(items.begin() + a, items.begin() + c, items.begin() + d);

    if (b != c) {
        int nl = b - a;
        int nr = d - c;
        std::rotate(items.begin() + (a + nr), items.begin() + (a + nr + nl), items.begin() + d);
    }
}

tuple<uint64_t, uint64_t> graph_writer_t::idx_t::get(uint64_t d) const
{
...
graph_writer_t::full_dim_t graph_writer_t::full_dim_t::singleton(uint64_t d)
{
    return full_dim_t({d});
}

vector<uint64_t> graph_writer_t::full_shape_t::full() const
{
    return vector_flatten(vector_from_each_member(parts, vector<uint64_t>, parts));
}

vector<uint64_t> graph_writer_t::full_shape_t::operator()() const
{
    return vector_from_each_method(parts, uint64_t, operator());
}

vector<tuple<int, int>> graph_writer_t::full_shape_t::get_breaks() const
{
    int                     b = 0;
...
vector<vector<uint64_t>> graph_writer_t::full_shape_t::as_vecvec() const
{
...
graph_writer_t::full_shape_t graph_writer_t::full_shape_t::from_full(vector<uint64_t> const& ss)
{
...
graph_writer_t::full_shape_t::from_vecvec(vector<vector<uint64_t>> const& ss)
{
    vector<full_dim_t> parts;
    parts.reserve(ss.size());
...
graph_writer_t::tensor_t::tensor_t(full_shape_t const& _shape, int _id, graph_writer_t* _self)
    : tensor_t(_shape, vector_iota<int>(_shape.full_rank()), _id, _self)
{
}

graph_writer_t::tensor_t::tensor_t(full_shape_t const& _shape,
...
graph_writer_t::tensor_t graph_writer_t::tensor_t::transpose(int i, int j) const
{
...
graph_writer_t::tensor_t::view(graph_writer_t::full_shape_t const& new_shape) const
{
...
graph_writer_t::tensor_t
graph_writer_t::tensor_t::view(vector<vector<uint64_t>> const& new_shape) const
{
    return view(full_shape_t::from_vecvec(new_shape));
}

graph_writer_t::tensor_t graph_writer_t::tensor_t::view_full() const
{
    return view(full_shape_t::from_full(shape.full()));
}

graph_writer_t::tensor_t
graph_writer_t::tensor_t::view_full(vector<uint64_t> const& full_shape) const
{
...
graph_writer_t::tensor_t graph_writer_t::tensor_t::save() const
{
...
graph_writer_t::tensor_t graph_writer_t::tensor_t::scale(scalar_t const& val) const
{
    return self->scale(val, *this);
}

graph_writer_t::tensor_t graph_writer_t::tensor_t::scale(string const& val) const
{
    return self->scale(val, *this);
}

graph_writer_t::tensor_t graph_writer_t::tensor_t::to_complex() const
{
    return self->to_complex(*this);
}

graph_writer_t::tensor_t graph_writer_t::tensor_t::to_real() const
{
    return self->to_real(*this);
}

graph_writer_t::tensor_t graph_writer_t::tensor_t::to_dtype(dtype_t d) const
{
    return self->to_dtype(d, *this);
}

graph_writer_t::tensor_t graph_writer_t::tensor_t::to_f16() const
{
    return self->to_f16(*this);
}

graph_writer_t::tensor_t graph_writer_t::tensor_t::to_f32() const
{
    return self->to_f32(*this);
}

graph_writer_t::tensor_t graph_writer_t::tensor_t::to_f64() const
{
    return self->to_f64(*this);
}

graph_writer_t::tensor_t
graph_writer_t::tensor_t::subset(vector<graph_writer_t::idx_t> const& idxs) const
{
    auto _shape = shape();
...
graph_writer_t::tensor_t graph_writer_t::tensor_t::squeeze(int which_dim) const
{
...
graph_writer_t::tensor_t graph_writer_t::tensor_t::sum_to_unit() const
{
    return self->sum_to_unit(*this);
}

bool graph_writer_t::tensor_t::_has_permutation() const
{
...
graph_writer_t::tensor_t graph_writer_t::tensor_t::physically_permute() const
{
    tensor_t ret = *this;
    ...
    ret.id = self->_insert_elementwise(str, scalarop_t::make_identity(dtype), ret.id);
    std::iota(ret.modes.begin(), ret.modes.end(), 0);

    return ret;
}

vector<graph_writer_t::tensor_t> graph_writer_t::backprop(graph_writer_t::tensor_t         out,
...
graph_writer_t::tensor_t graph_writer_t::input(vector<uint64_t> shape, dtype_t dtype)
{
    return this->input(full_shape_t::from_full(shape), dtype);
}

graph_writer_t::tensor_t graph_writer_t::input(full_shape_t shape, dtype_t dtype)
{
    int id = graph.insert_input(shape.full(), dtype);
    return tensor_t(shape, id, this);
}

graph_writer_t::tensor_t graph_writer_t::input(vector<vector<uint64_t>> const& shape, dtype_t dtype)
{
    return this->input(full_shape_t::from_vecvec(shape), dtype);
}

graph_writer_t::tensor_t
graph_writer_t::constant(scalar_t value, vector<uint64_t> shape, dtype_t dtype)
{
    return this->constant(value, full_shape_t::from_full(shape), dtype);
}

graph_writer_t::tensor_t graph_writer_t::fill(fill_t const& fill)
{
    int id = graph.insert_fill(fill);
    return tensor_t(full_shape_t::from_full(fill.shape()), id, this);
}

graph_writer_t::tensor_t graph_writer_t::constant(scalar_t value, full_shape_t shape, dtype_t dtype)
{
...
graph_writer_t::tensor_t
graph_writer_t::constant(scalar_t value, vector<vector<uint64_t>> const& shape, dtype_t dtype)
{
    return this->constant(value, full_shape_t::from_vecvec(shape), dtype);
}

graph_writer_t::full_shape_t graph_writer_t::to_einsummable_info_t::get_out_shape() const
{
    return full_shape_t(
        vector<full_dim_t>(join_shape.parts.begin(), join_shape.parts.begin() + out_rank));
}

einsummable_t
graph_writer_t::to_einsummable_info_t::build_einsummable(scalarop_t           join,
                                                         optional<castable_t> castable) const
{
    return einsummable_t(join_shape.full(), full_inns, full_out_rank, join, castable);
}

graph_writer_t::tensor_t graph_writer_t::contraction(string                          str,
                                                     ...
                                                     graph_writer_t::tensor_t const& rhs)
{
    ...
    einsummable_t e =
        info.build_einsummable(scalarop_t::make_mul(lhs.get_dtype()), castable_t::add);
    ...
    return tensor_t(info.get_out_shape(), id, this);
}

graph_writer_t::tensor_t
graph_writer_t::reduction(string str, castable_t castable, graph_writer_t::tensor_t const& inn)
{
    ...
    einsummable_t e = info.build_einsummable(scalarop_t::make_identity(inn.get_dtype()), castable);
...
graph_writer_t::tensor_t graph_writer_t::ew(scalarop_t op, graph_writer_t::tensor_t const& inn)
{
...
graph_writer_t::tensor_t
graph_writer_t::ew(string str, scalarop_t op, graph_writer_t::tensor_t const& inn)
{
    return ew(str, op, vector<tensor_t>{inn});
}

graph_writer_t::tensor_t graph_writer_t::ew(string                          str,
                                            scalarop_t                      op,
                                            graph_writer_t::tensor_t const& lhs,
                                            graph_writer_t::tensor_t const& rhs)
{
...
graph_writer_t::tensor_t
graph_writer_t::ew(string str, scalarop_t op, vector<graph_writer_t::tensor_t> const& inns)
{
...
graph_writer_t::tensor_t graph_writer_t::concat(int                                     dim,
                                                vector<graph_writer_t::tensor_t> const& inns_)
{
    ...
    for (tensor_t const& inn : inns) {
        ...
        if (j - i != 1) {
            throw std::runtime_error("graph writer concat: only full dims can be concated");
        }
    }
    ...
    full_shape_t shape = inns[0].shape;
    {
        vector<vector<uint64_t>> shapes =
            vector_from_each_method(inns, vector<uint64_t>, get_shape().operator());
...
graph_writer_t::tensor_t graph_writer_t::subset(vector<tuple<uint64_t, uint64_t>> const& hrect,
                                                tensor_t const&                          inn)
{
    ...
    for (int i = 0; i != rank; ++i) {
        ...
        if (dim_idx_b + 1 != dim_idx_e) {
            ...
            if (is_subset_dim(i)) {
                throw std::runtime_error("only subsetting singleton dimensions are supported");
            }
        }
    }
...
graph_writer_t::tensor_t graph_writer_t::to_real(graph_writer_t::tensor_t const& inn)
{
...
graph_writer_t::tensor_t graph_writer_t::to_complex(graph_writer_t::tensor_t const& inn)
{
...
graph_writer_t::tensor_t graph_writer_t::to_dtype(dtype_t dtype, tensor_t const& inn)
{
    if (dtype == dtype_t::c64) {
        throw std::runtime_error("cannot call dtype with c64; maybe call to_real instead");
    }
...
graph_writer_t::tensor_t graph_writer_t::insert_complexer(graph_writer_t::tensor_t tensor)
{
...
graph_writer_t::tensor_t graph_writer_t::matmul(graph_writer_t::tensor_t const& lhs,
                                                graph_writer_t::tensor_t const& rhs)
{
    int nl = lhs.rank();
    int nr = rhs.rank();
...
graph_writer_t::tensor_t graph_writer_t::exp(graph_writer_t::tensor_t const& inn)
{
    return ew(scalarop_t::make_exp(inn.get_dtype()), inn);
}
...
graph_writer_t::tensor_t graph_writer_t::softmax_v1(graph_writer_t::tensor_t const& inn)
{
    ...
    tensor_t c = reduction(redstr, castable_t::max, x);

    // y = x - c
    x = ew(ewbstr, scalarop_t::make_sub(dtype), x, c);

    // ex = exp(y)
    tensor_t ex = ew(scalarop_t::make_exp(dtype), x);

    tensor_t sum_ex = reduction(redstr, castable_t::add, ex);

    return ew(ewbstr, scalarop_t::make_div(dtype), ex, sum_ex);
}

graph_writer_t::tensor_t graph_writer_t::softmax_v2(graph_writer_t::tensor_t const& inn)
{
    dtype_t dtype = inn.get_dtype();
    ...
    // ex = exp(x-c)
    scalarop_t sub_then_exp =
        scalarop_t::combine(scalarop_t::make_exp(dtype), {scalarop_t::make_sub(dtype)});
    tensor_t ex = ew(ewbstr, sub_then_exp, x, c);
...
graph_writer_t::tensor_t graph_writer_t::softmax_v3(graph_writer_t::tensor_t const& inn)
{
    return softmax_v3_scale(scalar_t::one(inn.get_dtype()), inn);
}

graph_writer_t::tensor_t graph_writer_t::softmax_v3_scale(scalar_t                        alpha,
                                                          graph_writer_t::tensor_t const& inn)
{
    ...
    scalarop_t subscale =
        scalarop_t::combine(scalarop_t::make_scale(alpha), {scalarop_t::make_sub(dtype)});
    scalarop_t subscale_then_exp = scalarop_t::combine(scalarop_t::make_exp(dtype), {subscale});

    tensor_t sum_ex;
    {
        auto maybe = make_einsummable_info(ha + "," + h + "->" + h, {x, c});
        if (!maybe) {
        ...
        int out_id = graph.insert_einsummable(
            info.build_einsummable(subscale_then_exp, castable_t::add), {x.get_id(), c.get_id()});
    ...
    {
        auto maybe = make_einsummable_info(ha + "," + h + "," + h + "->" + ha, {x, c, sum_ex});
        if (!maybe) {
        ...
        scalarop_t with_div = scalarop_t::combine(
            scalarop_t::make_div(dtype), {subscale_then_exp, scalarop_t::make_identity(dtype)});

        int out_id = graph.insert_einsummable(info.build_einsummable(with_div),
...
graph_writer_t::tensor_t graph_writer_t::broadcast(graph_writer_t::full_dim_t      b_dim,
                                                   graph_writer_t::tensor_t const& tensor)
{
    ...
    full_shape_t new_shape(vector_concatenate({b_dim}, tensor.get_shape().parts));

    einsummable_t e = [&] {
        auto [inns, out_rank] = einsummable_t::parse_str(str);
        return einsummable_t(
            new_shape.full(), inns, out_rank, scalarop_t::make_identity(tensor.get_dtype()));
    }();
...
graph_writer_t::tensor_t graph_writer_t::broadcast(uint64_t sz, graph_writer_t::tensor_t const& inn)
{
    return broadcast(full_dim_t::singleton(sz), inn);
}

graph_writer_t::tensor_t graph_writer_t::sum_to_unit(graph_writer_t::tensor_t const& inn)
{
    int              id = inn.get_id();
    dtype_t          dtype;
...
graph_writer_t::tensor_t graph_writer_t::add(graph_writer_t::tensor_t const& lhs,
                                             graph_writer_t::tensor_t const& rhs)
{
    return straight_bew(scalarop_t::make_add(lhs.get_dtype()), lhs, rhs);
}

graph_writer_t::tensor_t graph_writer_t::mul(graph_writer_t::tensor_t const& lhs,
                                             graph_writer_t::tensor_t const& rhs)
{
    return straight_bew(scalarop_t::make_mul(lhs.get_dtype()), lhs, rhs);
}

graph_writer_t::tensor_t graph_writer_t::straight_bew(scalarop_t                      op,
                                                      graph_writer_t::tensor_t const& lhs,
                                                      graph_writer_t::tensor_t const& rhs)
{
    ...
    return ew(x + "," + x + "->" + x, op, lhs, rhs);
}

graph_writer_t::tensor_t graph_writer_t::scale(string val, graph_writer_t::tensor_t const& inn)
{
    dtype_t dtype = inn.get_dtype();
    return scale(scalar_t(dtype, val), inn);
}

graph_writer_t::tensor_t graph_writer_t::scale(scalar_t val, graph_writer_t::tensor_t const& inn)
{
    string x(inn.rank(), ' ');
    std::iota(x.begin(), x.end(), 'a');
...
int graph_writer_t::_insert_elementwise(string str, scalarop_t op, int id)
{
    auto [inns, out_rank] = einsummable_t::parse_str(str);
    if (inns.size() != 1) {
...
graph_writer_t::make_einsummable_info(string str, vector<graph_writer_t::tensor_t> const& tensors)
{
    ...
    return to_einsummable_info_t{.join_shape = full_join_shape,
                                 .full_inns = full_inns,
                                 .full_out_rank = full_out_rank,
                                 .out_rank = out_rank};
}

bool operator==(graph_writer_t::full_dim_t const& lhs, graph_writer_t::full_dim_t const& rhs)
{
...
bool operator==(graph_writer_t::full_shape_t const& lhs, graph_writer_t::full_shape_t const& rhs)
{
    return vector_equal(lhs.parts, rhs.parts);
}
bool operator!=(graph_writer_t::full_shape_t const& lhs, graph_writer_t::full_shape_t const& rhs)
...
std::ostream& operator<<(std::ostream& out, graph_writer_t::full_shape_t const& shape)
{
    out << shape();
    return out;
}
