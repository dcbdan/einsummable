...
struct select_t {
    ...
    wrt_output_point(vector<uint64_t> const& inn_point, // a point with respect to an input tensor
    ...
    vector<tuple<hrect_t, int>> collect(hrect_t out_hrect) const;
