...
using touch_kernel_t = std::function<void(cudaStream_t, void*, void const*)>;
using cutensor_kernel_t = std::function<
    void(cudaStream_t, cutensorHandle_t, void*, vector<void const*>, void*, uint64_t)>;

using cutensor_elementwise_kernel_t =
    std::function<void(cudaStream_t, cutensorHandle_t, void*, vector<void const*>)>;

using cuda_kernel_t = std::function<void(cudaStream_t, float*, float const*)>;

using void_cuda_kernel_t = std::function<void(cudaStream_t, void*, void const*)>;
...
uint64_t reduction_worksize(einsummable_t           einsummable,
                            void*                   out,
