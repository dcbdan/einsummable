...
struct send_channel_manager_t : rm_template_t<int, send_channel_manager_resource_t>
// desc_t { int the_loc }
{
...
private:
    optional<send_channel_manager_resource_t> try_to_acquire_impl(int const& loc);
...
struct recv_channel_manager_t : rm_template_t<tuple<int, int>, recv_channel_manager_resource_t>
...
private:
    optional<recv_channel_manager_resource_t> try_to_acquire_impl(tuple<int, int> const& desc);
