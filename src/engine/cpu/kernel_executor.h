...
public:
    ...
    void operator()(touch_t const& touch, void* out, void const* inn) const;
    ...
    using kernel_info_t = std::variant<batch_matmul_t,
                                       contraction_t,
                                       unary_straight_ew_t,
    ...
    static void call(kernel_info_t const&             info,
                     void*                            out,
                     vector<void const*>              inns,
...
private:
    ...
    optional<batch_matmul_t> make_batch_matmul(einsummable_t const& e);
};
...
void scale_kernel(scalar_t const& scalar, uint64_t nelem, void* out);

void broadcast_b_ab_kernel(scalar_t const& scalar,
                           uint64_t        nelem_a,
                           uint64_t        nelem_b,
                           void*           out,
                           void const*     inn);
...
void lowertri_fill(scalar_t lower,
                   scalar_t upper,
                   int64_t  nrow,
                   int64_t  ncol,
                   int64_t  start,
