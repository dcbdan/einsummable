...
struct cpu_tg_einsummable_t : exec_graph_t::op_base_t {
    cpu_tg_einsummable_t(map<int, data_manager_t::info_t>& dinfos,
                         cpu_kernel_executor_t&            a,
                         einsummable_t const&              b,
                         int                               c,
                         vector<int> const&                d,
                         uint64_t                          e)
        : cpu_executor(a), einsummable(b), out(c), inns(d), workspace_size(e)
    {
...
struct cpu_tg_batchmatmul_t : exec_graph_t::op_base_t {
    cpu_tg_batchmatmul_t(map<int, data_manager_t::info_t>& dinfos,
                         dtype_t                           dtype,
                         uint64_t                          nb,
                         uint64_t                          offset_b,
                         uint64_t                          size_b,
...
struct cpu_tg_permute_t : exec_graph_t::op_base_t {
    cpu_tg_permute_t(map<int, data_manager_t::info_t>& dinfos,
                     dtype_t                           dtype,
                     vector<uint64_t> const&           inn_shape,
                     vector<int> const&                out_perm,
                     int                               out_tid,
                     int                               inn_tid)
        : dtype(dtype), inn_shape(inn_shape), out_perm(out_perm), out_tid(out_tid), inn_tid(inn_tid)
    {
        dinfos.at(out_tid).usage_rem++;
...
struct cpu_tg_fill_constant_t : exec_graph_t::op_base_t {
    cpu_tg_fill_constant_t(map<int, data_manager_t::info_t>& dinfos, int tid_, fill_t const& fill_)
        : tid(tid_), fill(fill_)
    {
...
struct tg_send_t : exec_graph_t::op_base_t {
    tg_send_t(map<int, data_manager_t::info_t>& dinfos, int a, int b, int c)
...
struct tg_recv_t : exec_graph_t::op_base_t {
    tg_recv_t(map<int, data_manager_t::info_t>& dinfos, int a, uint64_t b, int c)
...
struct tg_touch_t : exec_graph_t::op_base_t {
    tg_touch_t(map<int, data_manager_t::info_t>& dinfos, touch_t const& a, int b, int c, int d)
