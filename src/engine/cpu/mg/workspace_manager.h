...
struct cpu_workspace_manager_t : rm_template_t<uint64_t, cpu_workspace_resource_t> {
...
private:
    optional<cpu_workspace_resource_t> try_to_acquire_impl(uint64_t const& size);
