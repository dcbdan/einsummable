...
void resource_manager_t::release_impl(vector<resource_ptr_t> const& resources)
{
...
resource_ptr_t resource_manager_t::try_to_acquire_unit(desc_ptr_t desc)
{
...
void resource_manager_t::release_unit(resource_ptr_t resource)
{
    for (auto manager : managers) {
