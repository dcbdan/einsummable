...
map<int, dbuffer_t> main_rank_zero(
    // graph_t graph,
    ...
    args_t&                         args)
{
    ...
    vector<placement_t> placements =
        autoplace01(graph,
                    autoplace_config_t::make_default01(args.get<int>("world_size"),
                                                       args.get<int>("num_threads")));
...
map<int, dbuffer_t> run(communicator_t&     communicator,
                        graph_t const&      graph,
                        string              which_server,
                        map<int, dbuffer_t> input_data,
                        args_t&             args)
{
    ...
    vector<placement_t> placements =
        autoplace01(graph, autoplace_config_t::make_default01(1, num_threads));
