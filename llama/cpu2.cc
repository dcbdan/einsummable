...
// (2) the second token
void main_rank_zero_experiments(cpu_mg_server_t&          server,
                                ...
                                args_t&                   args)
{
    ...
    for (int i = 0; i != 1; ++i) {
        ...
        {
            dbuffer_t embeddings = lookup_embeddings(
                margs.vocab_size, margs.dim, embedding_matrix, token_maker.last_column());
...
void main_rank_zero(cpu_mg_server_t&          server,
                    tensor_reader_t&          reader,
                    llama_autoplacer_t const& autoplacer,
                    args_t&                   args)
{
